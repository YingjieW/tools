...
/**
 * Description: http://blog.csdn.net/stalwartwill/article/details/17373827
 *
 * @author yingjie.wang
 * @since 17/10/9 上午10:40
 */
public class ZipUtils {
    ...
    public static void zip(String srcPath, String zipPath, String zipFileName, boolean overrideZipFileIfExists) throws Exception {
        ...
        try {
            ...
            // 若不允许覆盖，则直接返回
            if (zipFile.exists() && !overrideZipFileIfExists) {
                return;
            }
            if (zipFile.exists() && overrideZipFileIfExists) {
                //删除已存在的目标文件
    ...
    public static void main(String[] args) throws Exception {
        String srcPath = "/Users/YJ/Downloads";
        String zipPath = "/Users/YJ/Documents/generator/test";
//        String zipFileName = "test"; // 如果不加zi后缀会报错。
        String zipFileName = "test.zip";
        ZipUtils.zip(srcPath, zipPath, zipFileName, true);
    }
}
